            ...
            public void onSuccess(String s) {
                RongIM.setUserInfoProvider(new RongIM.UserInfoProvider() {
                    ...
                    public UserInfo getUserInfo(String userId) {
                        UserInfo userInfo = new UserInfo(userId, "", Uri.parse(""));
                            ...
                            public void onResponse(Call<Map<String, Object>> call, Response<Map<String, Object>> response) {
                                if (response.body() != null) {
                                    if (response.body().get("code").equals("200")) {
                                        ...
                                        userInfo.setName(String.valueOf(map.get("userName")));
                                        userInfo.setPortraitUri(Uri.parse(Constant.remoteUrl +
                                                "user/portrait/" + map.get("userPortrait")));
                                    }
                                }
                            }
